...
// Add basePath as a prop, with a default value for safety
function TicketItem({ ticket, basePath = "/tickets" }) {
  const getStatusClasses = (status) => {
    switch (status) {
      ...
      case "reopened":
        return "bg-cyan-700 text-white font-bold";
      default:
    ...
    <div className="grid grid-cols-1 md:grid-cols-7 gap-4 p-3 lg:p-4 hover:bg-gray-50 transition-colors cursor-pointer items-center border-b border-gray-100 last:border-b-0">
      ...
      <div className="flex justify-end md:justify-start">
        <Link
          ...
          // --- CHANGE IS HERE: Use the basePath prop
      ...
      <div className="md:hidden col-span-full border-t border-gray-100 pt-3 mt-3">
        <h3 className="text-lg font-bold text-blue-800 mb-1">Ticket Summary</h3>
